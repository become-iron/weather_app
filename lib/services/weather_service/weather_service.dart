...
const weatherDataCacheKey = 'weatherData';

class WeatherService {
  static final client = http.Client();
  static const weatherServiceHost = 'api.openweathermap.org';

  static Future<ForecastResponse?> getCachedWeatherData() async {
    final cache = await SharedPreferences.getInstance();
    final String? cachedData = cache.getString(weatherDataCacheKey);
  ...
  static Future<ForecastResponse> getWeatherData({
    ...
    final cache = await SharedPreferences.getInstance();
    cache.setString(weatherDataCacheKey, response.body);
